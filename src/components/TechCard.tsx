...
export default function TechCard({ tech, isDarkMode, isSelected, onToggleSelect }: TechCardProps) {
  return (
    <div
      ...
      className={`flex flex-col justify-between p-5 rounded-2xl border transition-all duration-200 cursor-pointer ${
        isSelected
    ...
    >
      ...
      <div>
        ...
        <p className={`mt-2 text-xs leading-relaxed line-clamp-3 min-h-[54px] ${
