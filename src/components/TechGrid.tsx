                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                    ...
                    <div className="lg:col-span-3">
                        {loading ? (
                            ...
                            <div className={`flex flex-col items-center justify-center py-20 rounded-2xl border ${isDarkMode ? 'bg-slate-900/40 border-slate-800' : 'bg-white/60 border-slate-100 shadow-sm'
                                }`}>
                                ...
                                <p className={`text-sm font-semibold flex items-center space-x-1 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'
                                    }`}>
                    ...
                    {/* Your Stack Sidebar */}
                    <div className={`sticky top-24 p-5 rounded-2xl border transition-colors ${isDarkMode ? 'bg-slate-900/80 border-slate-800' : 'bg-white border-slate-100 shadow-sm'
                        }`}>
                        ...
                        <div className="mt-4 space-y-2.5">
                            {selectedTechs.length === 0 ? (
                                ...
                                selectedTechs.map((tech) => (
                                    <div
                                        key={tech.id}
                                        className={`flex items-center justify-between p-2.5 rounded-xl border ${isDarkMode ? 'bg-slate-800/60 border-slate-700/50' : 'bg-slate-50 border-slate-100'
                                            }`}
                                    >
