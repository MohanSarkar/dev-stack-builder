      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className={`mt-6 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 font-normal ${
            ...
            <div className="mt-8 flex flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href="#docs"
                className={`px-6 py-3 rounded-xl font-semibold border transition-colors text-sm sm:text-base ${
                  isDarkMode 
